...
public class Constants {
    ...
    public static final String ARM_SERVO_ANALOG_NAME = "DepositArmEncoder";
    ...
    public static double LINEAR_SLIDE_RANGE = 59644; // Range of the linear slide in encoder ticks

    // Positions of the servos
    public static double CLAW_OPEN_POSITION = 0.2;
    public static double CLAW_CLOSED_POSITION_FOR_SPECIMEN = 0.5;
    public static double CLAW_CLOSED_POSITION_FOR_SAMPLE = 0.4;
    ...
    public static double ARM_SPECIMEN_PICKUP_POSITION = 0.96;
    public static double ARM_BASKET_SCORING_POSITION = 0.71;
    public static double ARM_SPECIMEN_SCORING_FORWARD_POSITION = 0.13;
    public static double ARM_SPECIMEN_SCORING_BACKWARD_POSITION = 0.87;
    ...
    public static double TRANSFER_DELAY_FOR_GOTO_READY_POSITION = 0.65;

    public static double PICKUP_DELAY_FOR_GOTO_SPECIMEN_SCORING_POSE = 0.2;

    public static double SCORING_SPECIMEN_POSE_DELAY_FOR_MOVE_ARM = 0.5;

    public static double SCORING_SPECIMEN_DELAY_FOR_GOTO_READY_POSITION = 0.25;

    public static double SCORING_BASKET_DELAY_FOR_MOVING_ARM = 0.7;

    public static double SCORING_BASKET_DELAY_FOR_GOTO_READY_POSITION = 0.1;

    public static double DISCARD_DELAY_FOR_GOTO_READY_POSITION = 0.2;
    public static double DISCARD_DELAY_FOR_OPEN_CLAW = 0.2;

    public static final double LINEAR_SLIDE_READY_POSITION_THRESHOLD = 100;
}
