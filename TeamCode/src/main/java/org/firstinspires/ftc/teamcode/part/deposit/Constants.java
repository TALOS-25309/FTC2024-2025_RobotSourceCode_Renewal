...
public class Constants {
    ...
    public static final double LINEAR_SLIDE_SPECIMEN_PICKUP_POSITION_IN_CM = 10.0;
    public static final double LINEAR_SLIDE_LOW_BASKET_SCORING_POSITION_IN_CM = 20.0;
    public static final double LINEAR_SLIDE_HIGH_BASKET_SCORING_POSITION_IN_CM = 50.0;
    public static final double LINEAR_SLIDE_LOW_SPECIMEN_SCORING_FORWARD_POSITION_IN_CM = 30.0;
    public static final double LINEAR_SLIDE_LOW_SPECIMEN_SCORING_BACKWARD_POSITION_IN_CM = 30.0;
    public static final double LINEAR_SLIDE_HIGH_SPECIMEN_SCORING_FORWARD_POSITION_IN_CM = 40.0;
    public static final double LINEAR_SLIDE_HIGH_SPECIMEN_SCORING_BACKWARD_POSITION_IN_CM = 40.0;
