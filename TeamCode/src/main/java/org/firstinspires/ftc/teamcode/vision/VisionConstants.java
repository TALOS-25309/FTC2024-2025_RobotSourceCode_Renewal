...
public class VisionConstants {
    ...
    public static final double LIMELIGHT_HEIGHT = 28.0; // Height of the limelight in cm
    ...
    public static final double LIMELIGHT_X_DELTA = -10.0;
    public static final double LIMELIGHT_Y_DELTA = -3.5;
    ...
    public static int AREA_MARGIN = 15;
}
