...
class Constants {
    ...
    public static final String WRIST_UP_DOWN_ANALOG_INPUT_NAME = "IntakeWristEncoder";
    public static final String ARM_UP_DOWN_ANALOG_INPUT_NAME = "IntakeArmEncoder";
    public static final String ARM_ROTATION_ANALOG_INPUT_NAME = "IntakeTurretEncoder";
    ...
    public static double TURRET_RANGE_IN_DEGREE = 80; // Range of the turret in degrees (167 * RANGE)
    ...
    // Delays
    public static double MIN_DETECTION_DELAY_FOR_PICKUP = 0.35;

    public static double PICKUP_DELAY_FOR_MOVE_DOWN = 0.1;
    public static double PICKUP_DELAY_FOR_CLOSE_CLAW = 0.35;
    public static double PICKUP_DELAY_FOR_MOVE_UP = 0.55;
    public static double PICKUP_DELAY_FOR_CHECKING_PICKUP = 0.7;
